...
const InputBox = ({handleSendMessage, userMessage, setUserMessage, loading}) => {
  return (
    <footer>
        <form onSubmit={handleSendMessage} className="fixed -translate-x-[50%] -translate-y-[50%] bottom-0 userInput bg-neutral-950 border border-white/50 lg:w-2/3 w-[90%] flex items-center justify-between gap-5 lg:px-5 lg:py-2 py-1.5 px-3 rounded-full text-xs">
